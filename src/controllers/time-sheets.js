...
//   const tsIdx = timeSheets.findIndex((usrTs) => usrTs.tim
// eSheetId === parseInt(req.params.id, 10));
...
//   const filterByEmployee = timeSheets.filter((ts) => ts.employeeI
// d === parseInt(req.params.id, 10));
